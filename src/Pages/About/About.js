        ...
        <Container>
            <div>
                ...
                <div className="paragraph">
                    <p>I have Strong knowledge in Front End with experience in building Web Applications by using React.js for client side, Node.js/ Express.js for server side and MongoDB for database.</p>
                </div>
                <div className="row row-cols-1 row-cols-lg-2 pb-5">
                    <div className="col pt-3 paragraph">
                        ...
                        <p>Finally, by the grace of Almighty I have completed my course as a Front End Developer and developed more than 10 projects on React & Node. My dream is to become a software engineer and will accomplish one day.</p>
                    </div>
                    <div className="col">
